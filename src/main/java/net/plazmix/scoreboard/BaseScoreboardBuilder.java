...
import net.plazmix.scoreboard.animation.ScoreboardDisplayStaticAnimation;
...
public final class BaseScoreboardBuilder {
    ...
    public BaseScoreboard build() {
        BaseScoreboard baseScoreboard = new BaseScoreboard(scoreboardName, scoreboardLineMap);

        baseScoreboard.setScoreboardDisplay(scoreboardDisplay);
