...
import net.plazmix.protocollib.packet.scoreboard.WrapperPlayServerScoreboardDisplayObjective;
import net.plazmix.protocollib.packet.scoreboard.WrapperPlayServerScoreboardObjective;
...
public class BaseScoreboard {
    ...
    public void addScoreboardUpdater(@NonNull ScoreboardUpdater scoreboardUpdater,
            ...
            public void run() {
                ...
                for (Player playerReceiver : new ArrayList<>(playerReceiverCollection)) {
                    ...
                    if (!playerReceiver.isOnline())
                        removeScoreboardToPlayer(playerReceiver);
        ...
        }.runTaskTimer(PlazmixApiPlugin.getPlugin(PlazmixApiPlugin.class), durationTick, durationTick);
