...
public class PlayerTopsMysqlConvertibleDatabase implements PlayerTopsDatabase {

    private final String mysqlTable;
    private final String tableColumn;

    private final BiFunction<PlazmixUser, Integer, Integer> valueConversionFunction;
        ...
        CoreConnector.getInstance().getMysqlConnection().executeQuery(false,
                ...
                resultSet -> {
                    ...
                    while (resultSet.next()) {
                        ...
                        playerTopsByIds.put(playerId, valueConversionFunction.apply(PlazmixUser.of(playerId), playerValue));
                    }
